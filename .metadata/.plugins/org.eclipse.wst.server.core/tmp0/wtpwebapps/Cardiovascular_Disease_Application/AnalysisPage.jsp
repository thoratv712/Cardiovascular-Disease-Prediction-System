...
<head>
   ...
   <!-- jQuery local version for custom.js compatibility -->
   ...
   $(document).ready(function() {
      ...
      $('#accuracyChart').highcharts({
         ...
         title: {
            ...
            style: { color: '#1565C0', fontSize: '16px' }
         },
         xAxis: {
            categories: [
               'Random Forest',
      ...
      // ================================
      // Chart 2 - Combined Metrics
      // ================================
      $('#combinedChart').highcharts({
         chart: { type: 'column' },
         title: {
...
<body class="clinic_version">
   ...
   <div id="service" class="services wow fadeIn">
      <div class="container">
               ...
               <div class="metric-box"
                  ...
                  <table>
                     <tr>
                        <td>Accuracy:</td>
                        <td>
                           <strong><%=rf_acc%>%</strong>
                        </td>
                     </tr>
                     <tr>
                        <td>Precision:</td>
                        <td>
                           <strong><%=rf_pre%>%</strong>
                        </td>
                     </tr>
                     <tr>
                        <td>Recall:</td>
                        <td>
                           <strong><%=rf_rec%>%</strong>
                        </td>
                     </tr>
                     <tr>
                        <td>F1-Score:</td>
               ...
               <div class="metric-box"
                  ...
                  <table>
                     <tr>
                        <td>Accuracy:</td>
                        <td>
                           <strong><%=svm_acc%>%</strong>
                        </td>
                     </tr>
                     <tr>
                        <td>Precision:</td>
                        <td>
                           <strong><%=svm_pre%>%</strong>
                        </td>
                     </tr>
                     <tr>
                        <td>Recall:</td>
                        <td>
                           <strong><%=svm_rec%>%</strong>
                        </td>
                     </tr>
                     <tr>
                        <td>F1-Score:</td>
                        <td>
                           <strong><%=svm_f1%>%</strong>
                        </td>
                     </tr>
                  </table>
               </div>
               ...
               <div class="metric-box"
                  ...
                  <table>
                     <tr>
                        <td>Accuracy:</td>
                        <td>
                           <strong><%=hml_acc%>%</strong>
                        </td>
                     </tr>
                     <tr>
                        <td>Precision:</td>
                        <td>
                           <strong><%=hml_pre%>%</strong>
                        </td>
                     </tr>
                     <tr>
                        <td>Recall:</td>
                        <td>
                           <strong><%=hml_rec%>%</strong>
                        </td>
                     </tr>
                     <tr>
                        <td>F1-Score:</td>
                        <td>
                           <strong><%=hml_f1%>%</strong>
                        </td>
                     </tr>
                  </table>
               </div>
         ...
         <div class="row" style="margin-top:20px;">
            <div class="col-md-12">
               <div class="model-section">
                  <h4>Combined Metrics Comparison</h4>
         ...
         <div class="row" style="margin-top:25px;">
            <div class="col-md-12 text-center">
               <a href="AnalysisExport"
                  class="export-btn">
                  Export Metrics CSV
               </a>
               <a href="PredictRisk"
                  class="predict-btn-link">
   ...
   <div class="copyright-area wow fadeIn">
      <div class="container">
         <p style="color:#aaa; padding:15px 0;">
            © 2026 Life Care. All Rights Reserved.
         </p>
      </div>
   </div>
   ...
   <!-- Do NOT include all.js - causes exports error -->
